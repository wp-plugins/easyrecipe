    ...
    class EasyRecipePlus {
        ...
        */
        ...
        function adminBarMenu() {
            global $wp_admin_bar;
            $root_menu = array('parent' => false, 'id' => 'ERFormatMenu', 'title' => 'EasyRecipe Format', 'href' => admin_url('#'),
        ...
        function loadSettingsPage() {
            ...
            wp_enqueue_script('easyrecipe-settings', "$this->easyrecipeURL/js/easyrecipe-settings.js", array('jquery-ui-dialog', 'jquery-ui-slider', 'jquery-ui-autocomplete',
                                                                                                             'jquery-ui-tabs', 'jquery-ui-button'), $this->version, true);
        ...
        function addMenus() {
            $this->settings = new $this->settingsClass();
            $hook = add_menu_page('EasyRecipe Settings', 'EasyRecipe', 'manage_options', $this->pluginName, array($this->settings,
                                                                                                                  'showPage'), "$this->pluginsURL/$this->pluginName/images/chef16.png");
        ...
        function loadPostAdmin() {
            ...
            wp_enqueue_script('easyrecipe-entry', "$this->easyrecipeURL/js/easyrecipe-entry.js", array('jquery-ui-dialog', 'jquery-ui-autocomplete', 'jquery-ui-button',
                                                                                                       'jquery-ui-tabs'), $this->version, true);
            ...
            */
            ...
            if (current_user_can("edit_plugins")) {
                ...
                */
                ...
                wp_enqueue_script('easyrecipeformat', "$this->easyrecipeURL/js/easyrecipe-format.js", array('jquery', 'jquery-ui-slider', 'jquery-ui-autocomplete',
                                                                                                            'jquery-ui-accordion', 'jquery-ui-dialog', 'jquery-ui-tabs',
                                                                                                            'jquery-ui-button', 'json2'), $this->version, true);
