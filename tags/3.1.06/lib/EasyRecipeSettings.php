    ...
    */
    ...
    public function save($settings) {
        ...
        foreach ($this->defaultSettings as $key => $nil) {
            switch ($key) {
                ...
                case 'recipeTypes' :
                    ...
                    $this->settings[$key] = preg_replace('/ *\n+ */', '|', $values);
                    break;
                ...
                case 'erFirstName' :
                case 'erEmailAddress' :
                    $this->settings[$key] = trim(wp_filter_nohtml_kses($settings[$key]));
                    break;
        ...
        if ($subscribeChange) {
            ...
            $response = wp_remote_post($url, array ('method' => 'POST', 'timeout' => 20, 'redirection' => 0, 'httpversion' => '1.1', 'blocking' => true, 'headers' => array (), 'body' => $body, 'cookies' => array ()));
        }
    }
    ...
    public function showPage() {
        ...
        $data->ratingEasyRecipeChecked = $data->ratingDisableChecked = '';
