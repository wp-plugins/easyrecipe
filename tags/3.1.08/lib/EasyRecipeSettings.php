    ...
    class EasyRecipeSettings {
        ...
        */
        private $defaultSettings = array(
            ...
            'lblIngredients' => 'Ingredients', 'lblInstructions' => 'Instructions', 'lblNotes' => 'Notes', 'lblNutrition' => 'Nutrition Information', 'lblAuthor' => 'Author',
            'lblCuisine' => 'Cuisine', 'lblRecipeType' => 'Recipe type', 'lblPrepTime' => 'Prep time', 'lblCookTime' => 'Cook time', 'lblTotalTime' => 'Total time',
            'lblServes' => 'Serves', 'lblServeSize' => 'Serving size', 'lblCalories' => 'Calories', 'lblSugar' => 'Sugar', 'lblSodium' => 'Sodium', 'lblFat' => 'Fat',
            'lblSatFat' => 'Saturated fat', 'lblUnsatFat' => 'Unsaturated fat', 'lblTransFat' => 'Trans fat', 'lblCarbs' => 'Carbohydrates', 'lblFiber' => 'Fiber',
            'lblProtein' => 'Protein', 'lblCholesterol' => 'Cholesterol', 'lblRateRecipe' => 'Rate this recipe',
        ...
        public function save($settings) {
            ...
            foreach ($this->defaultSettings as $key => $nil) {
                switch ($key) {
                    ...
                    default :
                        // TODO - check that $settings[$key] exists
                        $this->settings[$key] = stripslashes(trim(wp_filter_nohtml_kses($settings[$key])));
                        break;
                }
            }
            ...
            if ($subscribeChange) {
                ...
                wp_remote_post($url, array('method' => 'POST', 'timeout' => 20, 'redirection' => 0, 'httpversion' => '1.1', 'blocking' => true, 'headers' => array(),
                                           'body' => $body, 'cookies' => array()));
            }
        }
