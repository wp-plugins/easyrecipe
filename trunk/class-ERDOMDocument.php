...
class ERDOMDocument extends DOMDocument {
     ...
     *
     * @param $totalRating int
     *            The total rating value
     * @param $nRatings int
     *            The number of indicidual ratings
     */
    public function setRating($totalRating, $nRatings) {
        ...
        $innerDiv = $this->getElementByClassName("ERRatingInner");
        
        if ($innerDiv) {
            $this->setStyle($innerDiv, "width", $width);
