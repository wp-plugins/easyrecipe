...
if (!class_exists('EasyRecipeDOMDocument', false)) {
    class EasyRecipeDOMDocument extends DOMDocument {
         ...
         * @param $tag string
         *            Tag of the items to search
         * @return array Array of DOMNode items that match
         */
        public function getElementsByClassName($className, $tag = "*", $node = null, $deep = true, $level = 0) {
         ...
         * @param $tag string
         *            Tag of the items to search
         * @return DOMNode The node that matched
         */
         ...
         *
         * @return A DOMNodeList containing all top level microdata items.
         *        
